...
<head>
	...
	<body onload="check(),sf()">
		<form id="recruitAction!returnCheckList" name="fm" action="check_list_update" method="post" enctype="multipart/form-data">
		...
		<table width="100%">
				...
				<tr>
					<td align="right">
						<input type="radio"  name="pass_passComment" value="通过"  checked onclick="sf()">通过
						<input type="radio"  name="pass_passComment" value="不通过"   onclick="ly()">不通过
		...
		<input type="hidden" name="operate" value="doAdopt">
			<table width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td class="TD_STYLE2" colspan="7">
						<textarea
							name="pass_passComment" id="passPasscomment" class="TEXTAREA_STYLE1"
