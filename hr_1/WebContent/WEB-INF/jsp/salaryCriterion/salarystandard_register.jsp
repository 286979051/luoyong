...
<html>
	...
	<body>
		...
		<form id="myform" method="post" action="addSalary_standard">
			<table width="100%">
				<tr>
					<td>
						<font color="black">您正在做的业务是：人力资源--薪酬标准管理--薪酬标准登记 </font>
					</td>
				</tr>
				<tr>
					<td align="right">
			...
			<table id="stable" width="100%" border="1" cellpadding=0 cellspacing=1
				...
				<tr>
					...
					<td width="168" class="TD_STYLE2">
						<input type="text" name="standard_id" value="${timeid}" readonly="readonly" class="INPUT_STYLE2"/>
					</td>
				...
				<tr>
					...
					<td class="TD_STYLE2">
						<input type="text" name="register" value="${user.user_name }" readonly="readonly" class="INPUT_STYLE2"/>
					</td>
					<td class="TD_STYLE1">
						登记时间
					</td>
