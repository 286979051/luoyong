...
public class Salary_grant_details {
	...
	public Salary_grant_details(int grd_id, String salary_grant_id, String human_id, String human_name,
			double bouns_sum, double sale_sum, double deduct_sum, double salary_standard_sum, double salary_paid_sum) {
		super();
		this.grd_id = grd_id;
		this.salary_grant_id = salary_grant_id;
		this.human_id = human_id;
