...
public class Engage_interviewService implements IEngage_interviewService{
	...
	public void Engage_interview_insert(Engage_interview engage_interview ) {
		engage_interviewDao.Engage_interview_insert(engage_interview);
	}
	...
	public void interview_update(Engage_resume engage_resume) {
		engage_interviewDao.interview_update(engage_resume);
	}
}
